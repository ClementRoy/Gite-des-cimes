...
<div class="row">
    <div class="col-md-9">
        <div class="block-flat">
            <div class="content">
                <form id="form-edit-user" method="post" action="/utilisateurs/infos/id/<?=$utilisateur->id ?>" class="form-horizontal group-border-dashed maped-form" data-parsley-validate>

                    <div class="form-group">
                        <label class="col-sm-4 control-label" for="form-utilisateur-prenom">Prénom</label>
                        <div class="col-sm-6">
                            <input id="form-utilisateur-prenom" name="form_utilisateur_prenom" class="form-control" type="text" data-toggle="tooltip" title="Renseignez le prénom de l'utilisateur." data-parsley-required="true" value="<?=$utilisateur->firstname; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label" for="form-utilisateur-nom">Nom</label>
                        <div class="col-sm-6">
                            <input id="form-utilisateur-nom" name="form_utilisateur_nom" class="form-control" type="text" data-toggle="tooltip" title="Renseignez le nom de l'utilisateur." data-parsley-required="true" value="<?=$utilisateur->lastname; ?>">
                        </div>
                    </div>
                    <div class="form-group">
        ...
        <div id="neo-affix">
            ...
            <div id="allias-submit" class="block-flat bars-widget">
                <div class="form-group text-center">
                    ...
                    <a href="/utilisateurs/infos/id/<?=$utilisateur->id; ?>">Annuler</a>
                </div>
            </div>
