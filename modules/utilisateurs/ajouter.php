    ...
    <div class="content">
        <form id="form-add-user" method="post" action="/utilisateurs/infos/id/<?=$id ?>" class="form-horizontal group-border-dashed maped-form" data-parsley-validate>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input id="form-utilisateur-mail" name="form_utilisateur_mail" class="form-control" type="email" data-toggle="tooltip" title="Renseignez l'adresse e-mail de l'utilisateur." data-parsley-required="true">
                </div>
            </div>
            ...
            <div class="form-group actions text-center">
                <div class="col-md-8 col-md-offset-2">
                    <input type="submit" class="btn btn-primary btn-rad btn-lg" name="submit-add" value="Enregistrer le nouvel utilisateur">
                    <span>OU</span>
