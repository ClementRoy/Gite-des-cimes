                    ...
                    <div class="row">
                        ...
                        <div class="form-group actions text-center">
                            <div class="col-md-8 col-md-offset-2">
                                <input type="hidden" name="submit-update" value="Enregister les modifications">
                                <input type="submit" class="btn btn-primary btn-rad btn-lg" value="Enregister les modifications">
                                <span>OU</span>
        ...
        <div id="neo-affix">
            <div id="allias-submit" class="block-flat bars-widget">
                <div class="form-group text-center">
                    ...
                    <a href="/hebergements/infos/id/<?=$hebergement->id; ?>">Annuler</a>
                </div>
            </div>
