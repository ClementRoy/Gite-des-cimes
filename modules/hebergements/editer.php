        ...
        <div class="col-md-12">
            <div class="block-flat">
                <div class="content">
                    ...
                    <form id="form-edit-hebergement" method="post" action="/hebergements/infos/id/<?=$hebergement->id ?>" class="form-horizontal group-border-dashed maped-form" parsley-validate>
