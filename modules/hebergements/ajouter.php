                    ...
                    <div class="row">
                        ...
                        <div class="form-group actions text-center">
                            <div class="col-md-8 col-md-offset-2">
                                <input type="hidden" name="submit-add" value="Enregistrer le nouvel hébergement">
                                <input type="submit" class="btn btn-primary btn-rad btn-lg" value="Enregistrer le nouvel hébergement">
                                <span>OU</span>
        ...
        <div id="neo-affix">
            <div id="allias-submit" class="block-flat bars-widget">
                <div class="form-group text-center">
                    <button class="btn btn-primary btn-block btn-rad">Enregistrer le nouvel hébergement</button>
                    <a href="/hebergements/">Revenir aux hébergements</a>
                </div>
            </div>
