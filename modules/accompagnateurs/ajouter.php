                ...
                <form id="form-add-accompagnateur" method="post" action="/accompagnateurs/infos/id/<?=$id ?>" class="form-horizontal group-border-dashed maped-form" data-parsley-validate>
                    ...
                    <div class="form-group actions text-center">
                        <div class="col-md-8 col-md-offset-2">
                            <input type="hidden" name="submit-add" value="Enregistrer le nouvel accompagnateur">
                            <input type="submit" class="btn btn-primary btn-rad btn-lg" value="Enregistrer le nouvel accompagnateur">
                            <span>OU</span>
        ...
        <div id="neo-affix">
            <div id="allias-submit" class="block-flat bars-widget">
                <div class="form-group text-center">
                    <button class="btn btn-primary btn-block btn-rad">Enregistrer le nouvel accompagnateur</button>
                    <a href="/accompagnateurs/">Annuler</a>
                </div>
            </div>
