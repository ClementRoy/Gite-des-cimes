          ...
          <div id="tableheader">
           <div class="search">
            ...
            <div class="col-lg-2 col-lg-offset-2 text-right">
                Résultats <span id="startrecord">1</span>-<span id="endrecord">10</span> sur <span id="totalrecords">49</span>
    ...
    <table id="table" class="table table-striped tinytable">
        <thead>
            <tr>
                <th class="asc"><h3>Prénom <i class="pull-right icon-sort"></i></h3></th>
                <th class="head"><h3>Nom <i class="pull-right icon-sort"></i></h3></th>
                <th class="head"><h3>Date de naissance <i class="pull-right icon-sort"></i></h3></th>
